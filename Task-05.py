...
if gain > cost:
    print(f'Компания работает с прибылью. Рентабельность составляет {(gain - cost) / gain * 100} %')
    pers_count = int(input('Введите число сотрудников компании: '))

    print(f'Прибыль компании в пересчете на одного сотрудника составляет {(gain - cost) / pers_count}')
else:
